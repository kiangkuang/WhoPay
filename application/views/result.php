	    ...
	    <div class="panel panel-default">
	      <div class="panel-heading">
	        <h4 class="panel-title">
	          <a data-toggle="collapse" href="#collapse<?= $count ?>"><?php echo ($user[0]." | $".round($user[1], 2, PHP_ROUND_HALF_UP)) ?></a>
	        </h4>
	      </div>
	      <div id="collapse<?= $count++ ?>" class="panel-collapse collapse">
	        ...
	        <div class="panel-body"><?php echo ($user[$i][0]." | $".round($user[$i][1], 2, PHP_ROUND_HALF_UP)) ?></div>
	        <?php endfor; ?> 
	      </div>
	    </div>
	  </div>
